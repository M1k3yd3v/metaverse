...
contract Land is ERC721 {
    ...
    constructor(
        ...
        cost = _cost;
        buildings.push(Building("cityHall", address(0x0), 0, 0, 0, 10, 10, 10));
        buildings.push(Building("Stadium", address(0x0), 0, 10, 0, 10, 5, 3));
        buildings.push(
            Building("University", address(0x0), 0, -10, 0, 10, 5, 3)
        );
        buildings.push(
            Building("Shopping pizza 1", address(0x0), 10, 0, 0, 5, 25, 5)
        );
        buildings.push(
            Building("Shopping pizza 2", address(0x0), -10, 0, 0, 5, 25, 5)
        );
    }
